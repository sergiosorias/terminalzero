...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		void CompleteCloseEntry(bool testCrc)
		{
            ...
            // dpereyra
			// Hay paquetes generados en ppc que no tienen el data descriptor, en esos casos
			// simplemente ignoro la excepcion
			int nOldAvailable = inputBuffer.Available;
			try
			{
				if ((flags & 8) != 0)
					ReadDataDescriptor();
			...
			{
				inputBuffer.Available = nOldAvailable;
			}
