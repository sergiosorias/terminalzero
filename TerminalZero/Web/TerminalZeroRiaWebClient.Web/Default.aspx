<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TerminalZeroRiaWebClient.Web._Default" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Main Page</title>
    <link rel="stylesheet" type="text/css" href="~/ASPNET/Styles/CSS-Styles.css" />
    <style type="text/css">
        html, body
        {
            height: 100%;
        ...
        .headerButtonParent
        {
            ...
            background-image: url('./ASPNET/images/btnNormal.png');
        }
        ...
        ul.topnav li span
        {
            ...
            height: 35px;
            float: left;
            background: url(ASPNET/Images/semaforo_blanco.png) no-repeat center center;
        }
        ul.topnav li span.subhover
        {
            background: url(ASPNET/Images/semaforo_verde.png) no-repeat center center;
            cursor: pointer;
        }
        ...
        html ul.topnav li ul.subnav li a
        {
            ...
            float: left;
            width: 180px;
            background: #333 url(ASPNET/Images/icon_template_inac.png) no-repeat 10px center;
            padding-left: 30px;
        }
        html ul.topnav li ul.subnav li a:hover
        {
            /*--Hover effect for subnav links--*/
            background: #222 url(ASPNET/Images/icon_template_active.png) no-repeat 10px center;
        }
    </style>
    <script type="text/javascript" language="javascript" src="ASPNET/Scripts/jquery-1.5.1.min.js"></script>
    <script type="text/javascript" language="javascript" src="ASPNET/Scripts/jquery-1.4.1-vsdoc.js"></script>
    <script type="text/javascript" language="javascript" src="ASPNET/Scripts/jquery-1.4.1.js"></script>
</head>
<body>
    <form id="form1" runat="server" style="height: 100%; width: 100%">
    <input type="hidden" runat="server" value="" id="filesToShow" />
    <div id="menuHeader" class="headerButtonParent" style="z-index: 1000; width: 140;
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#HyperLink1").click(function () {
                setFrameSource('./TerminalZeroClient.aspx');
            });
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="z-index: 1; height: 100%;
        width: 100%">
        <tr>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        <td style="padding-left: 15px; width: 180px; font-size: 18px; color: White" valign="middle"
                            align="left">
                            <img src="ASPNET/images/logo.png" height="40" width="180px" alt="Terminal Zero" />
                        </td>
        ...
        <tr>
            <td style="height: 100%; width: 100%;" valign="top">
                <iframe id="linkContent" frameborder="0" src="TerminalZeroClient.aspx" style="height: 100%;
                    width: 100%"></iframe>
            </td>
        </tr>
        <tr>
